...
import { getAllJobCards } from '../../components/services/jobcardSlice';
...
export default function ViewCard() {
  ...
  const handleOnExport = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, report + "Jobcards");
          ...
          <TableBody>
            {
              ...
              (
                <TableRow key={job.id}>
                  ...
                  <TableCell>{ job.workshop?.employee.firstName + ' ' + job.workshop?.employee.lastName}</TableCell>
